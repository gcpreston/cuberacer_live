...
config :cuberacer_live,
  ecto_repos: [CuberacerLive.Repo]

# Configures the endpoint
config :cuberacer_live, CuberacerLiveWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: CuberacerLiveWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: CuberacerLive.PubSub,
  live_view: [signing_salt: "VKWxrG3t"]
