...
config :cuberacer_live, CuberacerLiveWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "re/Mu4+n6polUOYRMIaxIhd49RjO2PdSxR0nFLdoULvGugVAAdY2D4WmdMT5c1fX",
  watchers: [
...
config :cuberacer_live, :empty_room_timeout_ms, :timer.seconds(10_000)
